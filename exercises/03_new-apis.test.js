test.only(`should be easier to determine whether a string includes another`, () => {
...
test.only(`should be easier to repeat a string`, () => {
...
test.only(`should be able to take an array-like object and convert it into an array`, () => {
...
test.only(`should be easier to fill an array with values`, () => {
...
test.only(`should be easy to copy properties from one object to another`, () => {
  const source1 = {
    a: {
      b: 'c',
      m: [1, 2, 3],
...
*/
test.only('I submitted my elaboration and feedback', () => {
